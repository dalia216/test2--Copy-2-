...
(function () {
    ...
    // Database
    var db = {
        '🍗 لحوم': [{ n: 'صدور دجاج', m: { c: 165, p: 31, k: 0, f: 3.6 } }, { n: 'ورك دجاج', m: { c: 209, p: 26, k: 0, f: 10 } }, { n: 'لحم ستيك', m: { c: 180, p: 28, k: 0, f: 7 } }, { n: 'لحم مفروم', m: { c: 176, p: 20, k: 0, f: 10 } }, { n: 'كفتة مشوية', m: { c: 280, p: 18, k: 5, f: 20 } }, { n: 'كبدة', m: { c: 250, p: 20, k: 6, f: 15 } }, { n: 'بانيه', m: { c: 290, p: 18, k: 15, f: 16 } }],
        '🍞 نشويات': [{ n: 'أرز أبيض', m: { c: 130, p: 2.7, k: 28, f: 0.3 } }, { n: 'أرز بني', m: { c: 111, p: 2.6, k: 23, f: 0.9 } }, { n: 'مكرونة', m: { c: 158, p: 5.8, k: 31, f: 0.9 } }, { n: 'عيش بلدي', m: { c: 250, p: 9, k: 49, f: 2.5 } }, { n: 'شوفان', m: { c: 389, p: 16, k: 66, f: 7 } }, { n: 'بطاطس مسلوقة', m: { c: 87, p: 2, k: 20, f: 0.1 } }, { n: 'بطاطا حلوة', m: { c: 90, p: 2, k: 21, f: 0.1 } }],
        '🍎 فواكه': [{ n: 'موز', m: { c: 89, p: 1.1, k: 23, f: 0.3 } }, { n: 'تفاح', m: { c: 52, p: 0.3, k: 14, f: 0.2 } }, { n: 'برتقال', m: { c: 47, p: 0.9, k: 12, f: 0.1 } }, { n: 'مانجو', m: { c: 65, p: 0.8, k: 17, f: 0.4 } }, { n: 'عنب', m: { c: 69, p: 0.7, k: 18, f: 0.2 } }, { n: 'بطيخ', m: { c: 30, p: 0.6, k: 8, f: 0.2 } }],
        '🧀 ألبان': [{ n: 'حليب كامل', m: { c: 61, p: 3.2, k: 4.8, f: 3.3 } }, { n: 'زبادي', m: { c: 60, p: 3.5, k: 4.7, f: 3.3 } }, { n: 'جبنة قريش', m: { c: 98, p: 11, k: 3.4, f: 4.3 } }, { n: 'جبنة فيتا', m: { c: 264, p: 14, k: 4, f: 21 } }, { n: 'بيض مسلوق', m: { c: 155, p: 13, k: 1.1, f: 11 } }],
        '🐟 أسماك': [{ n: 'بلطي مشوي', m: { c: 128, p: 26, k: 0, f: 3 } }, { n: 'سلمون', m: { c: 208, p: 20, k: 0, f: 13 } }, { n: 'تونا ماء', m: { c: 116, p: 26, k: 0, f: 1 } }, { n: 'جمبري', m: { c: 99, p: 24, k: 0.2, f: 0.3 } }],
        '🥜 مكسرات': [{ n: 'لوز', m: { c: 579, p: 21, k: 22, f: 50 } }, { n: 'سوداني', m: { c: 585, p: 24, k: 21, f: 50 } }, { n: 'كاجو', m: { c: 553, p: 18, k: 30, f: 44 } }, { n: 'عين جمل', m: { c: 654, p: 15, k: 14, f: 65 } }],
        '💪 مكملات': [{ n: 'واي بروتين', m: { c: 120, p: 24, k: 3, f: 1 } }, { n: 'كازين', m: { c: 120, p: 24, k: 3, f: 1 } }, { n: 'ماس جينر', m: { c: 380, p: 15, k: 70, f: 4 } }]
    };

    var curList = [], lastResult = {}, allItems = [];
    Object.keys(db).forEach(k => db[k].forEach(i => { i.cat = k; allItems.push(i); }));
    ...
    function loadList(catName) {
        curList = catName === '📋 الكل' ? allItems : db[catName];
